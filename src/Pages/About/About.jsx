    ...
    <div className={styles.mainContainer}>
      ...
      <div className={styles.content}>
        ...
        <div className={styles.paragraph}>
          ...
          transforming ideas into digital realities. Specialising in E-commerce websites,
          UI/UX prototypes, business websites, booking platforms, and portfolios, we blend
          creativity with technology to craft online experiences that leave a lasting
          impression.
        </div>
        ...
        <div className={styles.paragraph}>
          ...
          collaboration - your ideas are at the core of our projects, and we work hand in
          hand to bring them to life. From concept to execution, we are dedicated to
          achieving excellence in every detail. Choose UC for a partnership that goes
          beyond development; choose us for a journey where creativity meets technology to
